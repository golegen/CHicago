...
.global GDTLoad
GDTLoad:
	movq %rdi, (GDTPointerBase)
	movw %si, (GDTPointerLimit)
	
	lgdt (GDTPointerLimit)
	
	pushq $0x08
	pushq $GDTLoad.Reload
	lretq
GDTLoad.Reload:
...
.global IDTLoad
IDTLoad:
	movq %rdi, (IDTPointerBase)
	movw %si, (IDTPointerLimit)
	lidt (IDTPointerLimit)
	ret
